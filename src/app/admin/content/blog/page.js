...
export default function BlogAdmin(){
    ...
    return(
        ...
        <div className="border-2 rounded-lg w-7/12 m-auto">
                ...
                <form onSubmit={""} method="POST">
                    ...
                    <div className="my-2 grid grid-cols-1">
                        ...
                        <input name="author" className="mx-auto" type="text" onChange={""} />
                    </div>
                    <br/>
                    <div className="my-2 grid grid-cols-1">
                        <h1 className="text-center text-lg font-bold">category</h1>
                        <input name="category" className="mx-auto" type="text" onChange={""} />
                    </div>
                    <br/>
                    <div className="my-2 grid grid-cols-1">
        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 justify-items-center mb-20">
            <AdminCard title="asdasdasd" id="123123" image="/images/news/recent/cblog.png"/>
            <AdminCard title="asdasdasd" id="123123" image="/images/news/recent/cblog.png"/>
            <AdminCard title="asdasdasd" id="123123" image="/images/news/recent/cblog.png"/>
