...
export default function AdminPortoCard({image="",title="not found",id=""}){
    ...
    <Link href={`/admin/content/portofolio/${id}`} className="m-auto items-center text-center">
        <img class="m-auto rounded-lg w-48 h-28 md:w-[400px] md:h-[240px]" src={image} alt=""/>
    </Link>
    <div class="md:p-4 p-3 text-center">
        <Link href={`/admin/content/portofolio/${id}`}>
